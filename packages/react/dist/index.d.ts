...
import { ElementType, ComponentProps as ComponentProps$2, ReactNode } from 'react';
import * as Avatar$1 from '@radix-ui/react-avatar';
import * as Checkbox$1 from '@radix-ui/react-checkbox';
import * as TooltipPrimitive from '@radix-ui/react-tooltip';
import * as Toast$1 from '@radix-ui/react-toast';

declare type ComponentProps<T> = ComponentProps$1<T> & {
    as: ElementType;
};
...
declare type TextProps = ComponentProps$2<typeof Text> & {
    as?: ElementType;
};
...
declare type HeadingProps = ComponentProps$2<typeof Heading> & {
    as?: ElementType;
};
...
declare type AvatarProps = ComponentProps$2<typeof AvatarImage>;
...
declare type ButtonProps = ComponentProps$2<typeof Button> & {
    as?: ElementType;
};
...
declare type TextInputProps = ComponentProps$2<typeof Input> & {
    prefix?: string;
};
...
declare type TextAreaProps = ComponentProps$2<typeof TextArea>;
...
declare type CheckboxProps = ComponentProps$2<typeof CheckboxContainer>;
...
declare type ToastProps = ComponentProps<typeof ToastRoot> & {
    title: string;
    description?: string;
};
